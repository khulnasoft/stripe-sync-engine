...
- Deploy the [docker image](https://hub.docker.com/r/khulnasoft/stripe-sync-engine) to your favourite hosting service and expose port `8080`
  - eg: `docker run -e PORT=8080 --env-file .env khulnasoft/stripe-sync-engine`
...
- Create a Postgres database on [khulnasoft.com](https://khulnasoft.com) (or another Postgres provider)
...
Khulnasoft is building the features of Firebase using enterprise-grade, open source products. We support existing communities wherever possible, and if the products don’t exist we build them and open source them ourselves.
